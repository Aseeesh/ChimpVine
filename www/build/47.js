...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__courses__ = __webpack_require__(2418);
    ...
    function CoreGradesCoursesPage(gradesProvider, domUtils, gradesHelper, tagProvider, tagAreaDelegate) {
        ...
        this.accordindata.forEach(function (element) {
            element.subjectList = [
                ...
                { subjectId: 14, category: _this.categorylist, rawgrade: null, courseFullName: "Social Studies", showCategoryDetails: false, icon: 'ios-add-circle-outline' }
            ];
